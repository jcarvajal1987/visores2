...
const $$Layout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html lang="en"><head><meta charset="UTF-8"><meta name="description" content="Astro description"><meta name="viewport" content="width=device-width"><link rel="icon" href="./icon.svg" type="image/svg+xml"><!-- <link rel="icon" type="image/svg+xml" href="/favicon.svg" /> --><link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><meta name="generator"${addAttribute(Astro2.generator, "content")}><title>${title}</title>${renderHead()}</head><body>${renderSlot($$result, $$slots["default"])}</body></html>`;
...
IZI PRESS # ${post.extra.numwords}</div><!-- <img src="./img/izimedia2.svg" alt="" class="logo" /> --></div><div class="printdetails"><div class="medio"><img class="company" src="img/latercera.png" alt=""><span>24horas.cl</span><span class="type">-</span><span class="type">Internet</span></div><div class="fecha"><img class="date" src="img/calendar.svg" alt=""><span>${fecha}</span></div><div class="fecha2"><img class="upload" src="img/up.svg" alt=""><span>${fechap} Hrs</span></div><div class="seccion"><img class="section" src="img/section3.svg" alt=""><span>Sección Nacional</span></div>${post.tono === 0 }${renderTemplate`<div class="denotacion denotation1 negativa ">
Connotación Negativa
</div>`}${post.tono === 2 }</div></div><div id="pdf" class="papel">${post.tipo === 3 }${post.tipo === 1 }${renderTemplate`<div class="title">${post.titulo}</div>`}${post.tipo === 3 }${post.tipo === 1 }${renderTemplate`<div class="cachetxt">${unescapeHTML(post.cachetxt)}</div>`}${post.tipo === 3 }</div></div><div class="hidden-pdf xs pointer detail-layout"><div id="SidebarToggle" class="abrir flex">
Detalles<img style="padding-top: 5px;" width="22" height="21.33" alt="options" src="img/right.svg"></div></div></div><div id="Sidebar" class="columnb"><div class="detalles"><div class="items"><span class="hidden-details block"><div class="medio"><img class="company" src="img/latercera.png" alt=""><span>24horas.cl</span><span class="type">-</span><span class="type">Internet</span></div><div class="fecha"><!-- <Image src={myImage} alt="A description of my image." /> --><img class="date" src="img/calendar.svg" alt=""><span>${fecha}</span></div>${post.tono === 0 }${renderTemplate`<div class="denotacion denotation1 negativa ">
Connotación Negativa
</div>`}${post.tono === 2 }<div class="seccion"><img class="section" src="img/section3.svg" alt="section" width="17" height="10.56"><span>Sección Nacional</span></div><div class="fecha2"><img class="upload" src="img/up.svg" alt=""><span>${fechap} Hrs</span></div></span>${// <img class="miniature" src={post.url_img} alt="" width="1600" height="900" />
