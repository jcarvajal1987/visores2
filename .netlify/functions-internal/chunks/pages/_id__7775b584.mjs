...
const $$Layout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html lang="en"><head><meta charset="UTF-8"><meta name="description" content="Astro description"><meta name="viewport" content="width=device-width"><!-- <link rel="icon" type="image/svg+xml" href="/favicon.svg" /> --><link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><meta name="generator"${addAttribute(Astro2.generator, "content")}><title>${title}</title>${renderHead()}</head><body>${renderSlot($$result, $$slots["default"])}</body></html>`;
...
<\/script>`])), renderComponent($$result, "Layout", $$Layout, { "title": "Welcome to Astro." }, { "default": ($$result2) => renderTemplate`${maybeRenderHead()}<main id="main"><div class="columna"><div class="start1"><div class="navbar"><div class="izibrand flex align-center"><svg class="logo" width="114" height="57" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 60 30" style="enable-background:new 0 0 60 30;" xml:space="preserve"><style type="text/css">
	.st0{fill:#F4B302;}
	.st1{fill:#FFFFFF;}
	.st2{fill:#12202E;}
	.st3{fill:#002350;}
</style><g><g><g><g><path class="st0" d="M59.5,16.45c-0.45-0.66-1.15-1.07-1.89-1.18c0,0,0,0,0.03,0c-1.26-0.29-2.44-1.05-3.22-2.2
					...
					c-0.16,0.73-0.03,1.52,0.42,2.18c0.86,1.28,2.62,1.6,3.91,0.73C60.05,19.46,60.39,17.73,59.5,16.45z"></path><circle class="st1" cx="57.14" cy="18.05" r="1.6"></circle><path class="st2" d="M57.14,16.6c-0.29,0-0.55,0.08-0.79,0.24c0.16,0.08,0.29,0.24,0.29,0.45c0,0.26-0.21,0.47-0.47,0.47
					c-0.16,0-0.29-0.08-0.37-0.18c-0.05,0.16-0.08,0.31-0.08,0.5c0,0.79,0.63,1.44,1.44,1.44c0.81,0,1.44-0.63,1.44-1.44
					C58.58,17.26,57.95,16.6,57.14,16.6z"></path><path class="st1" d="M55.8,17.55c0.08,0.1,0.21,0.18,0.37,0.18c0.26,0,0.47-0.21,0.47-0.47c0-0.18-0.1-0.37-0.29-0.45
					C56.12,17,55.91,17.26,55.8,17.55z"></path></g><path class="st1" d="M55.8,17.55c0.08,0.1,0.21,0.18,0.37,0.18c0.26,0,0.47-0.21,0.47-0.47c0-0.18-0.1-0.37-0.29-0.45
				C56.12,17,55.91,17.26,55.8,17.55z"></path></g></g><rect y="10.86" class="st3" width="1" height="9.99"></rect><polygon class="st3" points="2.49,14.09 2.49,14.98 7.18,14.98 2.96,20.12 2.36,20.85 9.04,20.85 9.04,19.96 4.38,19.96 
		9.17,14.09 	"></polygon><path class="st3" d="M10.85,12.1c-0.18,0-0.31,0.05-0.45,0.18c-0.13,0.13-0.18,0.26-0.18,0.45s0.05,0.31,0.18,0.45
		s0.26,0.18,0.45,0.18s0.31-0.05,0.45-0.18s0.18-0.26,0.18-0.45s-0.05-0.31-0.18-0.45C11.17,12.17,11.01,12.1,10.85,12.1z"></path><rect x="10.35" y="14.09" class="st3" width="1" height="6.76"></rect><path class="st3" d="M21.65,14.09c-1.15,0-2.07,0.5-2.73,1.52c-0.66-1-1.57-1.52-2.73-1.52c-0.89,0-1.63,0.31-2.25,0.92
		...
		c-0.03-0.89-0.34-1.68-0.97-2.28C23.28,14.4,22.52,14.09,21.65,14.09z"></path><path class="st3" d="M32.48,15.35c-0.58-0.71-1.36-1.13-2.28-1.23c-0.94-0.08-1.78,0.18-2.46,0.73c-0.71,0.55-1.1,1.34-1.23,2.28
		...
		C30.59,15.14,31.03,15.32,31.4,15.63z"></path><path class="st3" d="M40.63,17.31v-0.03v-6.42h-1v4.19c-0.66-0.66-1.44-1-2.39-1c-0.92,0-1.73,0.34-2.39,1
		...
		c0,0.66-0.24,1.21-0.71,1.68C38.48,19.62,37.9,19.85,37.25,19.85z"></path><rect x="42.28" y="14.09" class="st3" width="1" height="6.76"></rect><path class="st3" d="M42.78,12.1c-0.18,0-0.31,0.05-0.45,0.18c-0.13,0.13-0.18,0.26-0.18,0.45s0.05,0.31,0.18,0.45
		...
		"></path><path class="st3" d="M50.67,15.08c-0.66-0.66-1.47-1-2.39-1s-1.73,0.34-2.39,1c-0.66,0.66-1,1.47-1,2.39c0,0.92,0.34,1.73,1,2.39
		...
		c0.66,0,1.23,0.24,1.7,0.71c0.47,0.47,0.71,1.02,0.71,1.7c0,0.66-0.24,1.23-0.71,1.68C49.51,19.62,48.94,19.85,48.28,19.85z"></path></g></svg><!-- <img class="logo" src="img/izimedia2.svg" alt="" width="114" height="57" /> --><div class="izipress">
IZI PRESS # ${post.extra.numwords}</div><!-- <img src="./img/izimedia2.svg" alt="" class="logo" /> --></div><div class="printdetails"><div class="medio"><img class="company" src="img/latercera.png" alt=""><span>24horas.cl</span><span class="type">-</span><span class="type">Internet</span></div><div class="fecha"><img class="date" src="img/calendar.svg" alt=""><span>${fecha}</span></div><div class="fecha2"><img class="upload" src="img/up.svg" alt=""><span>${fechap} Hrs</span></div><div class="seccion"><img class="section" src="img/section3.svg" alt=""><span>Sección Nacional</span></div>${post.tono === 0 && renderTemplate`<div class="denotacion denotation0">
Connotación Positiva
</div>`}${post.tono === 1 && renderTemplate`<div class="denotacion denotation1 negativa ">
Connotación Negativa
</div>`}${post.tono === 2 && renderTemplate`<div class="denotacion denotation2">
Connotación Neutral
</div>`}</div></div><div id="pdf" class="papel">${post.tipo === 3 && renderTemplate`<div class="container grid"><video id="2" class="video start1 invisibility print-visibility "${addAttribute(post.url_img, "src")}></video><video controls autoplay id="2" class="video start1 print-block print-invisibility"${addAttribute(post.url_img, "src")}></video></div>`}${post.tipo === 1 && renderTemplate`<div class="title-papel">${post.titulo}</div>`}${post.tipo === 2 && renderTemplate`<div class="title">${post.titulo}</div>`}${post.tipo === 3 && renderTemplate`<div class="title-video">${post.titulo}</div>`}${post.tipo === 1 && renderTemplate`<div class="cachetxt-papel">${unescapeHTML(post.cachetxt)}</div>`}${post.tipo === 2 && renderTemplate`<div class="cachetxt">${unescapeHTML(post.cachetxt)}</div>`}${post.tipo === 3 && renderTemplate`<div class="cachetxt">${unescapeHTML(post.cachetxt)}</div>`}</div></div><div class="hidden-pdf xs pointer detail-layout"><div id="SidebarToggle" class="abrir flex">
Detalles<img style="padding-top: 5px;" width="22" height="21.33" alt="options" src="img/right.svg"></div></div></div><div id="Sidebar" class="columnb"><div class="detalles"><div class="items"><span class="hidden-details block"><div class="medio"><img class="company" src="img/latercera.png" alt=""><span>24horas.cl</span><span class="type">-</span><span class="type">Internet</span></div><div class="fecha"><!-- <Image src={myImage} alt="A description of my image." /> --><img class="date" src="img/calendar.svg" alt=""><span>${fecha}</span></div>${post.tono === 0 && renderTemplate`<div class="denotacion denotation0">
Connotación Positiva
</div>`}${post.tono === 1 && renderTemplate`<div class="denotacion denotation1 negativa ">
Connotación Negativa
</div>`}${post.tono === 2 && renderTemplate`<div class="denotacion denotation2">
Connotación Neutral
  ...
  renderTemplate`${renderComponent($$result2, "Image", $$Image, { "class": "miniature", "src": post.url_img, "alt": "Imagen Realacionada", "width": "320", "height": "180" })}`}<div class="flex pt2 gap hidden-pdf"><div id="url" class="copiar"><img class="chain" src="img/copiar.svg" alt=""><span class="precopy">Copiar Url</span><span class="postcopy hidden">Url Copiado!</span></div><div onclick="window.print()" id="download" class="descargar"><img class="download" src="img/pdf.svg" alt="descargar pdf"><span>Generar Pdf</span><span class="hidden">Generado!</span></div></div></div><div class="hidden-pdf xs pointer detail-layout2"><div id="SidebarToggleIn" class="cerrar flex">
